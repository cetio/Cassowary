...
namespace Cassowary.Intrinsics
{
    ...
    /// </summary>
    public sealed class Signature<TReturn> : BaseSignature
    {
        /// <summary>
        ...
        public unsafe TReturn Invoke<T>(ref T instance, params object[] parameters)
        {
            return (TReturn)InvokeInternal(ref instance, this, parameters);
        }
        ...
        /// <param name="parameters">The parameters to invoke the method with.</param>
        /// <returns>The return of the invocation.</returns>
        public unsafe TReturn Invoke(params object[] parameters)
        {
            return (TReturn)InvokeInternal(this, parameters);
        }
    }
}
