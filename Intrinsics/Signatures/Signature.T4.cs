...
namespace Cassowary.Intrinsics
{
    ...
    /// </summary>
    public sealed class Signature<T1, T2, T3, TReturn> : BaseSignature
    {
        /// <summary>
        ...
        public unsafe TReturn Invoke<T>(ref T instance, T1 param1, T2 param2, T3 param3)
        {
            return (TReturn)InvokeInternal(ref instance, this, param1, param2, param3);
        }
        ...
        /// </summary>
        /// <remarks>
        /// To invoke on an instance, use <see cref="Invoke{T}(ref T, T1, T2, T3)"/>
        /// </remarks>
        /// <returns>The return of the invocation.</returns>
        public unsafe TReturn Invoke(T1 param1, T2 param2, T3 param3)
        {
            return (TReturn)InvokeInternal(this, param1, param2, param3);
        }
    }
}
