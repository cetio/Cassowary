...
using Cassowary.Signatures.Factories;
...
namespace Cassowary.Signatures
{
    public abstract class BaseSignature
    {
        ...
        public unsafe Type ReturnType
        {
            get
            {
                return (Type)Intrinsics.GetMethodTable(NativeSignature)->GetClass()->GetField("m_returnTypeORfieldType")->GetValueSafe(NativeSignature);
            }
        }
        ...
        public unsafe CallingConvention CallingConvention
        {
            get
            {
                return (CallingConvention)Intrinsics.GetMethodTable(NativeSignature)->GetClass()->GetField("m_managedCallingConventionAndArgIteratorFlags")->GetValueSafe(NativeSignature);
            }
        }
